...
PROJ_NAME = "m8tool"
LIB_NAME = "m8tool"
# if not empty, copies built libs to this directory
GODOT_ADDON_DIR = ""
BUILD_DIR = "build"
GODOT_VERSION = "4.7.1"
GODOT_BRANCH = "stable"
...
def exec_cargo_build(
    ...
    match platform:
        case "macos":
            ...
            if is_lib:
                if GODOT_ADDON_DIR != "":
                    move(file_uni, f"{GODOT_ADDON_DIR}/{release_or_debug}/{filename}")
            else:
        ...
        case "windows":
            ...
            if is_lib:
                ...
                if GODOT_ADDON_DIR != "":
                    move(filepath, f"{GODOT_ADDON_DIR}/{release_or_debug}/{filename}")
            else:
